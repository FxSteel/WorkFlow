...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex w-[480px] bg-black relative flex-col justify-between p-10 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Gestiona tus proyectos<br />con facilidad
          </h1>
          <p className="text-white/80 text-lg leading-relaxed max-w-sm">
            Organiza tareas, programa sprints y colabora con tu equipo en tiempo real.
          </p>

          <div className="space-y-4 pt-4">
            <FeatureItem text="Espacios de trabajo múltiples" />
            <FeatureItem text="Sprints y tableros Kanban" />
            <FeatureItem text="Asignación de tareas por equipo" />
            <FeatureItem text="Seguimiento de prioridades" />
          </div>
        </div>

        <div className="relative z-10">
          <p className="text-white/50 text-sm">
            &copy; 2026 WorkFlow. Todos los derechos reservados.
          </p>
        </div>
      </div>
          ...
          <div className="w-full max-w-[400px] animate-fade-in">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                ...
                {mode === 'register' && 'Regístrate para empezar a gestionar tus proyectos'}
            ...
            {mode !== 'forgot' && (
              <>
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-border bg-card text-foreground hover:bg-accent transition-colors text-sm font-medium disabled:opacity-50"
                >
            ...
            {success && (
              <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-success/10 border border-success/20 mb-4 animate-scale-in">
